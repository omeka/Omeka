 ...
 * Controller
 */
define('KEA_CONTROLLER_PATH', 'app/controllers');

/**
 * Theme
 */
define('KEA_THEME_PATH', 'public/themes');
...
define('APP_NAME', 'SITEBUILDER r. KIWI');


define('DEFAULT_CONTROLLER', 'simple');
define('DEFAULT_ACTION', 'index');
define('DEFAULT_NO_ACTION', 'noAction');
