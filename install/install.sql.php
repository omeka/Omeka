...
INSERT INTO `{$db->prefix}elements` VALUES (2, 2, 2, 3, NULL, 'Interviewer', 'The person(s) performing the interview.');
INSERT INTO `{$db->prefix}elements` VALUES (3, 2, 2, 3, NULL, 'Interviewee', 'The person(s) being interviewed.');
INSERT INTO `{$db->prefix}elements` VALUES (4, 2, 2, 3, NULL, 'Location', 'The location of the interview.');
INSERT INTO `{$db->prefix}elements` VALUES (5, 2, 1, 3, NULL, 'Transcription', 'Any written text transcribed from a sound.');
INSERT INTO `{$db->prefix}elements` VALUES (6, 2, 2, 3, NULL, 'Local URL', 'The URL of the local directory containing all assets of the website.');
INSERT INTO `{$db->prefix}elements` VALUES (7, 2, 2, 3, NULL, 'Original Format', 'If the image is of an object, state the type of object, such as painting, sculpture, paper, photo, and additional data');
INSERT INTO `{$db->prefix}elements` VALUES (10, 2, 2, 3, NULL, 'Physical Dimensions', 'The actual physical size of the original image.');
INSERT INTO `{$db->prefix}elements` VALUES (11, 2, 2, 3, NULL, 'Duration', 'Length of time involved (seconds, minutes, hours, days, class periods, etc.)');
INSERT INTO `{$db->prefix}elements` VALUES (12, 2, 2, 3, NULL, 'Compression', 'Type/rate of compression for moving image file (i.e. MPEG-4)');
INSERT INTO `{$db->prefix}elements` VALUES (13, 2, 2, 3, NULL, 'Producer', 'Name (or names) of the person who produced the video.');
INSERT INTO `{$db->prefix}elements` VALUES (14, 2, 2, 3, NULL, 'Director', 'Name (or names) of the person who produced the video.');
INSERT INTO `{$db->prefix}elements` VALUES (15, 2, 2, 3, NULL, 'Bit Rate/Frequency', 'Rate at which bits are transferred (i.e. 96 kbit/s would be FM quality audio)');
INSERT INTO `{$db->prefix}elements` VALUES (16, 2, 2, 3, NULL, 'Time Summary', 'A summary of an interview given for different time stamps throughout the interview');
...
INSERT INTO `{$db->prefix}elements` VALUES (18, 2, 2, 3, NULL, 'Subject Line', 'The content of the subject line of the email.');
INSERT INTO `{$db->prefix}elements` VALUES (19, 2, 2, 3, NULL, 'From', 'The name and email address of the person sending the email.');
INSERT INTO `{$db->prefix}elements` VALUES (20, 2, 2, 3, NULL, 'To', 'The name(s) and email address(es) of the person to whom the email was sent.');
INSERT INTO `{$db->prefix}elements` VALUES (21, 2, 2, 3, NULL, 'CC', 'The name(s) and email address(es) of the person to whom the email was carbon copied.');
INSERT INTO `{$db->prefix}elements` VALUES (22, 2, 2, 3, NULL, 'BCC', 'The name(s) and email address(es) of the person to whom the email was blind carbon copied.');
INSERT INTO `{$db->prefix}elements` VALUES (23, 2, 2, 3, NULL, 'Number of Attachments', 'The number of attachments to the email.');
...
INSERT INTO `{$db->prefix}elements` VALUES (28, 2, 2, 3, NULL, 'URL', '');
INSERT INTO `{$db->prefix}elements` VALUES (29, 2, 2, 3, NULL, 'Event Type', '');
...
INSERT INTO `{$db->prefix}elements` VALUES (31, 2, 9, 3, NULL, 'Birth Date', '');
INSERT INTO `{$db->prefix}elements` VALUES (32, 2, 2, 3, NULL, 'Birthplace', '');
INSERT INTO `{$db->prefix}elements` VALUES (33, 2, 9, 3, NULL, 'Death Date', '');
INSERT INTO `{$db->prefix}elements` VALUES (34, 2, 2, 3, NULL, 'Occupation', '');
...
INSERT INTO `{$db->prefix}elements` VALUES (37, 1, 2, 1, 8, 'Contributor', 'An entity responsible for making contributions to the resource. Examples of a Contributor include a person, an organization, or a service. Typically, the name of a Contributor should be used to indicate the entity.');
INSERT INTO `{$db->prefix}elements` VALUES (38, 1, 2, 1, 15, 'Coverage', 'The spatial or temporal topic of the resource, the spatial applicability of the resource, or the jurisdiction under which the resource is relevant. Spatial topic and spatial applicability may be a named place or a location specified by its geographic coordinates. Temporal topic may be a named period, date, or date range. A jurisdiction may be a named administrative entity or a geographic place to which the resource applies. Recommended best practice is to use a controlled vocabulary such as the Thesaurus of Geographic Names [TGN]. Where appropriate, named places or time periods can be used in preference to numeric identifiers such as sets of coordinates or date ranges.');
INSERT INTO `{$db->prefix}elements` VALUES (39, 1, 2, 1, 4, 'Creator', 'An entity primarily responsible for making the resource. Examples of a Creator include a person, an organization, or a service. Typically, the name of a Creator should be used to indicate the entity.');
INSERT INTO `{$db->prefix}elements` VALUES (40, 1, 9, 1, 7, 'Date', 'A point or period of time associated with an event in the lifecycle of the resource. Date may be used to express temporal information at any level of granularity. Recommended best practice is to use an encoding scheme, such as the W3CDTF profile of ISO 8601 [W3CDTF].');
...
INSERT INTO `{$db->prefix}elements` VALUES (42, 1, 2, 1, 11, 'Format', 'The file format, physical medium, or dimensions of the resource. Examples of dimensions include size and duration. Recommended best practice is to use a controlled vocabulary such as the list of Internet Media Types [MIME].');
INSERT INTO `{$db->prefix}elements` VALUES (43, 1, 2, 1, 14, 'Identifier', 'An unambiguous reference to the resource within a given context. Recommended best practice is to identify the resource by means of a string conforming to a formal identification system.');
INSERT INTO `{$db->prefix}elements` VALUES (44, 1, 2, 1, 12, 'Language', 'A language of the resource. Recommended best practice is to use a controlled vocabulary such as RFC 4646 [RFC4646].');
INSERT INTO `{$db->prefix}elements` VALUES (45, 1, 2, 1, 6, 'Publisher', 'An entity responsible for making the resource available. Examples of a Publisher include a person, an organization, or a service. Typically, the name of a Publisher should be used to indicate the entity.');
INSERT INTO `{$db->prefix}elements` VALUES (46, 1, 2, 1, 10, 'Relation', 'A related resource. Recommended best practice is to identify the related resource by means of a string conforming to a formal identification system.');
INSERT INTO `{$db->prefix}elements` VALUES (47, 1, 2, 1, 9, 'Rights', 'Information about rights held in and over the resource. Typically, rights information includes a statement about various property rights associated with the resource, including intellectual property rights.');
INSERT INTO `{$db->prefix}elements` VALUES (48, 1, 2, 1, 5, 'Source', 'A related resource from which the described resource is derived. The described resource may be derived from the related resource in whole or in part. Recommended best practice is to identify the related resource by means of a string conforming to a formal identification system.');
...
INSERT INTO `{$db->prefix}element_sets` VALUES (3, 2, 'Item Type Metadata', 'The item type metadata element set, consisting of all item type elements bundled with Omeka and all item type elements created by an administrator.');
