...
$searchableTables = array('items', 'collections');
	foreach ($searchableTables as $key => $table) {
		$sql = "CREATE TABLE `{$table}_fulltext` (`id` INT( 11 ) UNSIGNED NOT NULL AUTO_INCREMENT PRIMARY KEY ,`text` TEXT CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL ,FULLTEXT (`text`)) ENGINE = MYISAM ;";
