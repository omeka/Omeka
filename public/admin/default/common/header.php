	...
	<div id="wrap">
		<div id="header">
			...
			<?php
				...
				nav(array('Home' => uri(''),'Items' => uri('items/browse'), 'Types' => uri('types'), 'Collections' => uri('collections'), 'Tags' => uri('tags'), 'Themes' => uri('themes'), 'Plugins' => uri('plugins'),'Users' => uri('users'), 'Settings' =>uri('settings')));
