...
class ItemSearch
{
	...
	public function simple($terms)
	{
		...
		$db->exec("CREATE TEMPORARY TABLE IF NOT EXISTS $tempTable (item_id BIGINT UNIQUE, rank FLOAT(10) DEFAULT 1, PRIMARY KEY(item_id))");
	...
	//	echo $mSelect;
		...
		$itemSelect->from( array('i'=>"$db->Item"), array('item_id'=>'i.id', 'rank'=>$iSearchClause));
