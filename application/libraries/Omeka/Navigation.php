...
class Omeka_Navigation extends Zend_Navigation
{
     ...
     * The filter should provide an array of associative arrays like:
     * array(
     *  array('label' => $label_a, 'uri' => $uriOrPage_a)
     *  array('label' => $label_b, 'uri' => $uriOrPage_b)
     * );
     * where the $label is a link label and $uriOrPage
     * is either a uri string, Omeka_Navigation_Page_Uri, 
     * Zend_Navigation_Page_Uri, or Zend_Navigation_Page_Mvc.  
     * Before adding the values to this navigation object, this function 
     * will normalize and convert all values to either an
            ...
            case 'public_navigation_main':
                ...
                $pageLinks = array(
                    array('label' => __('Browse Items'),
                          'uri' => new Zend_Navigation_Page_Mvc(array('controller' => 'items', 'action' => 'browse', 'visible' => true))), 
                    array('label' => __('Browse Collections'), 
                          'uri' => new Zend_Navigation_Page_Mvc(array('controller' => 'collections', 'action' => 'browse', 'visible' => true))),                   
                    );
            break;
        }
