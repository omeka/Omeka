 ...
 * @package Omeka\Test
 */
abstract class Omeka_Test_AppTestCase extends Omeka_Test_TestCase
{
    ...
    /* End of code ported from Zend_Test_PHPUnit_ControllerTestCase */
    ...
    public function assertQuery($path, $message = '')
    {
        ...
        $this->assertNotCount(0, $result, $message);
    }
    ...
    public function assertNotQuery($path, $message = '')
    {
        ...
        $domQuery = new Zend_Dom_Query($content);
        $result = $domQuery->query($path);
        $this->assertCount(0, $result, $message);
    }
    ...
    public function assertQueryContentContains($path, $match, $message = '')
    {
        ...
        foreach ($result as $node) {
            $nodeContent = $this->_getNodeContent($node);
            if (strstr($nodeContent, $match)) {
                $contains = true;
                break;
            }
        }
    ...
    public function assertXpath($path, $message = '')
    {
        ...
        $result = $domQuery->queryXpath($path);
        $this->assertNotCount(0, $result, $message);
    }
