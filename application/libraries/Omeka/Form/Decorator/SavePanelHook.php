...
{    
    ...
    {        
        ...
        ob_start();
        fire_plugin_hook("admin_append_to_" . $pluralType . "_panel_buttons", array('view'=>$this, 'record'=>$record));        
        $buttonsHtml = ob_get_contents();
        ob_end_clean();
        
        ob_start();
        fire_plugin_hook("admin_append_to_" . $pluralType . "_panel_fields", array('view'=>$this, 'record'=>$record));
