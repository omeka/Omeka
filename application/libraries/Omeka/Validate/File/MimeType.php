...
class Omeka_Validate_File_MimeType extends Zend_Validate_File_MimeType
{
    ...
    public function __construct($options = null)
    {
        ...
        if (get_option(self::HEADER_CHECK_OPTION) == '1') {
