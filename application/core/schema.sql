...
INSERT INTO `%PREFIX%data_types` VALUES (2, 'Tiny Text', 'A short, typically one-line text string. Up to 255 characters.');
INSERT INTO `%PREFIX%data_types` VALUES (3, 'Date Range', 'A date range, begin to end. In format yyyy-mm-dd yyyy-mm-dd.');
INSERT INTO `%PREFIX%data_types` VALUES (4, 'Integer', 'Set of numbers consisting of the natural numbers including 0 (0, 1, 2, 3, ...) and their negatives (0, âˆ’1, âˆ’2, âˆ’3, ...).');
INSERT INTO `%PREFIX%data_types` VALUES (9, 'Date', 'A date in format yyyy-mm-dd');
INSERT INTO `%PREFIX%data_types` VALUES (10, 'Date Time', 'A date and time combination in the format: yyyy-mm-dd hh:mm:ss');
...
INSERT INTO `%PREFIX%element_sets` VALUES (1, 1, 'Dublin Core', 'The Dublin Core metadata element set. These elements are common to all Omeka resources, including items, files, collections, exhibits, and entities. See http://dublincore.org/documents/dces/.');
INSERT INTO `%PREFIX%element_sets` VALUES (3, 2, 'Item Type Metadata', 'The item type metadata element set, consisting of all item type elements bundled with Omeka and all item type elements created by an administrator.');
INSERT INTO `%PREFIX%element_sets` VALUES (4, 3, 'Omeka Legacy File', 'The metadata element set that, in addition to the Dublin Core element set, was included in the `files` table in previous versions of Omeka. These elements are common to all Omeka files. This set may be deprecated in future versions.');
INSERT INTO `%PREFIX%element_sets` VALUES (5, 3, 'Omeka Image File', 'The metadata element set that was included in the `files_images` table in previous versions of Omeka. These elements are common to all image files.');
INSERT INTO `%PREFIX%element_sets` VALUES (6, 3, 'Omeka Video File', 'The metadata element set that was included in the `files_videos` table in previous versions of Omeka. These elements are common to all video files.');
