...
class Globals_InsertCollectionTest extends Omeka_Test_AppTestCase
{
     ...
     * 
     * @param bool $isPublic Whether the collection is public or not
     * @param bool $isFeatured Whether the collection is featured or not
     * @param bool $isHtml Whether the collection has an HTML title or not
     */
