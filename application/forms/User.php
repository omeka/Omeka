    ...
    public function init()
    {
        ...
        if ($this->_hasRoleElement) {
            $this->addElement('select', 'role', [
                'label' => __('Role'),
                'description' => __("Roles describe the permissions a user has. See <a href='https://omeka.org/classic/docs/Admin/Users/' target='_blank'>documentation <span class='sr-only'>(external link)')</span></a> for details."),
