...
CREATE TABLE contributors (
	...
	contributor_religious_id			enum( 'reform', 'conservative', 'orthodox', 'secular', 'protestant', 'catholic', 'muslim', 'none', 'other', 'unknown')	default 'unknown',
	...
	contributor_return					enum( 'yes', 'no', 'unknown' ) NOT NULL	default 'unknown',
	contributor_family_members			enum( 'yes', 'no', 'unknown' ) NOT NULL	default 'unknown',
	contributor_former_resident			enum( 'yes', 'no', 'unknown' ) NOT NULL	default 'unknown',
	contributor_community_evacuees		enum( 'yes', 'no', 'unknown' ) NOT NULL	default 'unknown',
	contributor_participate				enum( 'yes', 'no', 'unknown' ) NOT NULL	default 'unknown',
