...
<img src="<?php echo $_link->in('favorite-on.gif', 'i');?>" border="0" title="Remove this favorite" />
<?php else: ?>
<img src="<?php echo $_link->in('favorite-off.gif', 'i');?>" border="0" title="Mark this a favorite" />
<?php endif; ?>
</a>