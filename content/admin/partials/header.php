...
<ul id="navigation">
	...
	<li id="nav-people"<?php if($current == 'users') {echo ' class="current"';} ?>><a href="<?php echo $_link->to( 'users' ); ?>">Users</a></li>
		<li id="nav-myarchive"<?php if($current == 'account') {echo ' class="current"';} ?>><a href="<?php echo $_link->to( 'account' ); ?>">My Archive</a></li>
<?php /*		<li id="nav-settings"<?php if($current == 'settings') {echo ' class="current"';} ?>><a href="<?php echo $_link->to( 'settings' ); ?>">Settings</a></li> */ ?>
	<?php endif; ?>
</ul>