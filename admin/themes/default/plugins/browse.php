<?php
function admin_theme_display_plugin($pluginDirName, $plugin, $loader)
{
...
<?php } // end admin_theme_display_plugin function ?>
...
<div id="primary">
    ...
    <?php if ($plugins): ?>
        ...
        <?php if ($plugin->isInstalled()) { $installedPlugins[$pluginDirName] = $plugin;  } else { $uninstalledPlugins[$pluginDirName] = $plugin; } ?>
        <?php endforeach; ?>
        ...
        <?php if ($installedPlugins): ?>
            ...
            <table id="plugin-info">
                ...
                <tbody>
                <?php foreach($plugins as $pluginDirName => $plugin): ?>
                    <?php if ($plugin->isInstalled()) { admin_theme_display_plugin($pluginDirName, $plugin, $loader); } ?>
                <?php endforeach; ?>
                </tbody>
            </table>
        <?php endif; ?>
        
        <?php if ($uninstalledPlugins): ?>        
