...
<?php elseif ('inactive' == $key): ?>
<h3>Inactive Plugins</h3>
<?php elseif ('uninstalled' == $key): ?>
<h3>Uninstalled Plugins</h3>
<?php endif; ?>
<?php if ($value): ?>
<table>
    <thead>
...
<?php else: ?>
<?php if ('active' == $key): ?>
<p><?php echo __('There are no active plugins.'); ?></p>
<?php elseif ('inactive' == $key): ?>
<p><?php echo __('There are no inactive plugins.'); ?></p>
<?php elseif ('uninstalled' == $key): ?>
<p><?php echo __('There are no uninstalled plugins.'); ?></p>
<?php endif; ?>
<?php endif; ?>
<?php endforeach; ?>
<?php else: ?>
