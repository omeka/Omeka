...
<div id="primary" class="filenotfound">
	...
	<ul class="items">
		...
		<li class="item"><a href="<?php echo uri('items/show/'.$item->id); ?>"><?php echo $item->title; ?></a></li>
		<?php endforeach; ?>
	</ul>
	</div>
	...
	<ul class="collections">
		...
		<li class="collection"><a href="<?php echo uri('collections/show/'.$collection->id); ?>"><?php echo $collection->name; ?></a></li>
		<?php endforeach; ?>
	</ul>
	</div>
