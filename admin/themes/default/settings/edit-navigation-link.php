...
<li>
    <div class="main_link">
        <div class="sortable-item drawer">
            ...
            <button type="button" id="drawer-toggle-<?php echo $checkboxId; ?>" class="drawer-toggle" aria-expanded="false" aria-label="' . __('Show Options') . '" aria-labelledby="drawer-<?php echo $checkboxId; ?> drawer-toggle-<?php echo $checkboxId; ?>"><span class="icon"></span></button>
            <button type="button" id="drawer-remove-<?php echo $checkboxId; ?>" class="delete-element" aria-label="<?php echo __('Remove'); ?>" aria-labelledby="drawer-remove-<?php echo $checkboxId; ?> drawer-<?php echo $checkboxId; ?>"  title="' . __('Remove') . '"><span class="icon"></span></button>
        </div>
