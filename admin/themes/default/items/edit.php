...
<form method="post" enctype="multipart/form-data" id="item-form" action="">
    ...
    <section class="three columns omega">
        <div id="save" class="panel">
            ...
            <?php fire_plugin_hook("admin_items_panel_buttons", ['view'=>$this, 'record'=>$item]); ?>
            
            <div id="public-featured">
                <?php if ( is_allowed('Items', 'makePublic') ): ?>
                    <div class="public">
                        <label for="public"><?php echo __('Public'); ?>:</label> 
                        <?php echo $this->formCheckbox('public', $item->public, [], ['1', '0']); ?>
                    </div>
                <?php endif; ?>
                <?php if ( is_allowed('Items', 'makeFeatured') ): ?>
                    <div class="featured">
                        <label for="featured"><?php echo __('Featured'); ?>:</label> 
                        <?php echo $this->formCheckbox('featured', $item->featured, [], ['1', '0']); ?>
                    </div>
                <?php endif; ?>
            ...
            <div id="collection-form" class="field">
                ...
                <?php fire_plugin_hook('admin_items_form_collection', ['item' => $item, 'view' => $this]); ?>
            </div> <!-- end collection-form div -->
            <?php fire_plugin_hook("admin_items_panel_fields", ['view'=>$this, 'record'=>$item]); ?>
        </div>
    </section>
</form>
<?php echo foot();?>
