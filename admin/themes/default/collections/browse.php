                ...
                <tbody>
                    ...
                    <tr class="collection<?php if(++$key%2==1) echo ' odd'; else echo ' even'; ?>">
                        <td class="title<?php if ($collection->featured) { echo ' featured';} ?>">
                            <?php 
                                $titleLinkContent  = (record_image('collection', 'square_thumbnail')) ? record_image('collection', 'square_thumbnail') : '';
                                $titleLinkContent .= metadata($collection, 'rich_title', array('no_escape' => true));
                            ?>

                            <span class="title">
                                <?php echo link_to_collection($titleLinkContent, array('class' => 'image')); ?>
