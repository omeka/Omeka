...
$acl->registerRule(new Zend_Acl_Resource('Collections'), array('add','edit','delete'));
...
$acl->registerRule(new Zend_Acl_Resource('Tags'), array('edit','delete'));
...
$acl->allow('admin','Collections',array('add','edit','delete'));
